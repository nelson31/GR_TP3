/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - MOTableModelListener.java  
  _## 
...
/**
 * A <code>MOTableModelListener</code> can be informed about table model
 * changes.
 *
 * @author Frank Fock
 * @version 1.0
...
public interface MOTableModelListener extends EventListener {
   ...
   * @param event
   *    the <code>MOTableModelEvent</code> instance that describes the change.
   */
