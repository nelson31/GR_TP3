/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - MOTableSubIndex.java  
  _## 
...
public class MOTableSubIndex {
    ...
    public MOTableSubIndex(int smiSyntax, int minLength, int maxLength) {
        ...
        if (minLength > maxLength) {
            throw new IllegalArgumentException("MOTableIndex minLength > maxLength: " + minLength + ">" + maxLength);
        }
     ...
     *
     * @return a SMI syntax as defined by {@link SMIConstants}.
     */
     ...
     *
     * @return the OID of the sub-index object or <code>null</code> if that has not
