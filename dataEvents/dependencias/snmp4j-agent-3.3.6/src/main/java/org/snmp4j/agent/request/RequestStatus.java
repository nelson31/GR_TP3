/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - RequestStatus.java  
  _## 
...
public class RequestStatus {
    ...
    private transient List<RequestStatusListener> requestStatusListeners;
    ...
    public synchronized void addRequestStatusListener(RequestStatusListener l) {
        if (this.requestStatusListeners == null) {
            this.requestStatusListeners = new ArrayList<>(2);
        }
    ...
    protected void fireRequestStatusChanged(RequestStatusEvent event) {
        if (requestStatusListeners != null) {
            List<RequestStatusListener> listeners = requestStatusListeners;
