/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - MOTableRowListener.java  
  _## 
...
public interface MOTableRowListener<R extends MOTableRow> extends EventListener {
   ...
   *    If {@link MOTableRowEvent#getNumberOfConsecutiveEventsOfSameOrigin()} is greater than zero you need to
   *    set {@link MOTableRowEvent#setSendNextEventsOfSameOrigin(boolean)} to {@code true} in order to receive those
   *    consecutive events too. Otherwise they will be ignored and not been propagated to this listener.
   */
