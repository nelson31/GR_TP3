...
public class OctetString extends AbstractVariable
     ...
     * radix.
     * @param string
     *    the string representation of an octet string or {@code null}
     * @param radix
     *    the radix of the string representation.
     * @return
     *    the OctetString instance or {@code null} if {@code string} is {@code null}.
     * @since 1.6
     */
    ...
    /**
     * Creates an OctetString from a {@code char} array by converting the delimited character sequence using the given
     * radix into a byte array internally. Intermediate conversion buffers will be filled with zero data immediately.
     * @param string
     *    a UTF-8 character sequence of encoded bytes by radix (i.e. radix of 16 parses a hexadecimal string.
     * @param delimiter
     *    the delimiter character between the byte representation character sequences.
     * @param radix
     *    the radix to be used while parsing.
     * @return
     *    an OctetString with the bytes parsed from {@code string}.
     * @since 3.4.1
     */
    ...
    /**
     * Returns an {@link OctetString} from the provided index OID decoded as OctetString with or without implied length.
     * @param subIndex an index OID sub-identifier sequence.
     * @param beginIndex that starting sub-identifier (zero-based) where the encoded OCTET STRING begins (inclusive)
     * @param impliedLength specifies if the first sub-identifier (at begin index) contains the encoded length of the
     *                      string or if {@code false} the rest of the {@code subIndex} will be decoded as OCTET STRING.
     * @return the specified OctetString.
     * @since 3.4.1
     */
