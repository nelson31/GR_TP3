...
public class MPv1 implements MessageProcessingModel {
    ...
    /**
     * Creates a SNMPv1 message processing model with a PDU factory for incoming messages that uses {@link PDUv1}.
     */
    public MPv1() {
    }

    /**
     * Creates a SNMPv1 message processing model with a custom PDU factory that must ignore the target parameter when
    ...
    public <A extends Address> int prepareResponseMessage(int messageProcessingModel,
        ...
        return prepareOutgoingMessage(stateReference.getAddress(), maxMessageSize, messageProcessingModel,
                securityModel, securityName, securityLevel, pdu, false,
                stateReference.getPduHandle(), outgoingMessage, null);
    }
