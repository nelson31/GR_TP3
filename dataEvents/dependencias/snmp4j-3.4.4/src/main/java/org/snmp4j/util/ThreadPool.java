...
/**
 * The {@code ThreadPool} provides a pool of a fixed number of threads
 * that are capable to execute tasks that implement the {@code Runnable}
...
public class ThreadPool implements WorkerPool {
     ...
     *
     * @return a {@code ThreadPool} instance.
     */
     ...
     * if {@link org.snmp4j.SNMP4JSettings#forwardRuntimeExceptions} is {@code true}. Otherwise, the
     ...
     * currently busy, this method returns {@code false}. Otherwise the task
     * is executed in background.
     *
     * @param task
     *         a {@code Runnable} to execute.
     *
     * @return {@code true} if the task is executing.
     * @since 1.6
     */
     ...
     * or canceled.
     *
     * @return {@code true} if threads are respawn.
     */
     ...
     *         if {@code true} then threads will be respawn.
     */
     ...
     *
     * @return {@code true} if all threads are idle.
     * @since 1.6
     */
    ...
    /**
     * The {@code TaskManager} executes tasks in a thread.
     *
     * @author Frank Fock
     * @version 3.0.6
     * @since 1.0.2
