 ...
 * <p>
 * This class uses AES in CFB mode to encrypt the data. The protocol is defined in draft-blumenthal-aes-usm-08.txt
 * (AES128) and draft-blumenthal-aes-usm-04.txt (AES192 and AES256).
 *
 * @author Jochen Katz
 * @version 2.5.0
 */
public abstract class PrivAES extends PrivacyGeneric
    ...
    public byte[] encrypt(byte[] unencryptedData, int offset, int length,
        ...
        buildInitVector(engineBoots, engineTime, initVect);
