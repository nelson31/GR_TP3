...
public class TLSTMExtendedTrustManagerFactory implements TLSTMTrustManagerFactory {
  ...
  private CounterSupport tlstmCounterSupport;
  private TlsTmSecurityCallback<X509Certificate> securityCallback;

  public TLSTMExtendedTrustManagerFactory(CounterSupport tlstmCounterSupport,
                                          TlsTmSecurityCallback<X509Certificate> securityCallback) {
    this.tlstmCounterSupport = tlstmCounterSupport;
  ...
  public X509TrustManager create(X509TrustManager trustManager, boolean useClientMode,
    ...
    return new TLSTMExtendedTrustManager(tlstmCounterSupport, securityCallback,
