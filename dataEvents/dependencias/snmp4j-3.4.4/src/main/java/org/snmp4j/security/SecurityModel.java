...
/**
 * The {@code SecurityModel} interface as described in RFC3411 section 4.4
...
public interface SecurityModel {
     ...
     * security model.
     * @return
     *    a new {@code SecurityParameters} instance.
     */
     ...
     * this security model.
     * @return
     *    a new {@code SecurityStateReference} instance.
     */
     ...
     * @param wholeMsg
     *    returns the complete generated message in a {@code BEROutputStream}.
     *    The buffer of {@code wholeMsg} is set to {@code null} by the
     ...
     *    a {@link SecurityStateReference} instance collecting information for
     *    response processing, i.e. should be {@code null} if no response is expected.
     *    This security state reference will be stored in the message processing model cache for response processing.
     * @throws IOException
     ...
     *    other {@code SnmpConstants.SNMPv3_USM_*} values is returned.
     */
     ...
     *    {@code maxSizeResponseScopedPDU} value.
     * @param securityParameters
     ...
     * @param wholeMsg
     *    the {@code BERInputStream} containing the whole message as received
     *    on the wire.
     * @param tmStateReference
     *    the transport model state reference as defined by RFC 5590.
     * @param securityEngineID
     ...
     *    {@code BEROutputStream}.
     *    The buffer of {@code scopedPDU} is set to {@code null} by the
     *    caller and must be set by the implementation of this method.
     * @param maxSizeResponseScopedPDU
     *    the determined maximum size for a response PDU.
     * @param securityStateReference
     *    the {@code SecurityStateReference} information needed for
     *    a response.
     * @param statusInfo
     *    the {@code StatusInformation} needed to generate reports if
     ...
     * engine ID discovery.
     * The {@link USM} for instance, returns {@code true} whereas
     * {@link TSM} returns {@code false}.
     * See also RFC 5343 3.2 for details.
     * @return
     *    {@code true} if this security model has its own authoritative
     ...
     * @return
     *    {@code true} if an authoritative engine ID is exchanged between
     *    command sender and responder using this security model, {@code false}
     *    otherwise.
     */
