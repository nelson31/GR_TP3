...
public abstract class AbstractVariable implements Variable, Serializable {
     ...
     *         an {@code BERInputStream} containing a BER encoded byte stream.
     *
     * @return an instance of a subclass of {@code Variable}.
     * @throws IOException
    ...
    public static Variable createFromBER(BERInputStream inputStream) throws
        ...
        if (SNMP4JSettings.isExtensibilityEnabled()) {
            ...
            try {
                variable = c.getDeclaredConstructor().newInstance();
                ...
                String errTxt =
                        "Failed to instantiate variable syntax class for: " + c.getName();
     ...
     *
     * @return a {@code Variable} variable instance of the supplied SMI syntax.
     */
    public static Variable createFromSyntax(int smiSyntax) {
        ...
        try {
            Variable variable = c.getDeclaredConstructor().newInstance();
            return variable;
        } catch (InvocationTargetException | IllegalAccessException |
                InstantiationException | NoSuchMethodException iex) {
            String errTxt =
                    "Failed to instantiate variable syntax class for: " + c.getName();
            logger.error(errTxt, iex);
     ...
     *
     * @return an integer value less than 128 for regular SMI objects and a value greater or equal than 128
     ...
     *
     * @return a textual description like 'Integer32' for {@code syntax}
     ...
     *
     * @return {@code false} by default. Derived classes may override this
