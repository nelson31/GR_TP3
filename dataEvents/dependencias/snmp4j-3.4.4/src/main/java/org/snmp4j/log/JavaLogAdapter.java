...
/**
 * The {@code JavaLogAdapter} log adapter provides logging for SNMP4J
 * through the Java logging ({@code java.util.logging}).
 *
 * @author Frank Fock
 * @version 3.4.1
 * @since 1.7.2
...
public class JavaLogAdapter implements LogAdapter {
    ...
    /**
     * Mapping from {@code org.snmp4j.log.LogLevel} to
     * {@code java.util.logging.Level}.
     *
     * @param logLevel
     *    The {@code LogLevel} to mapped
     * @return the {@code Level}
     *    mapped to or {@code null} if
     *    {@code null} was specified as the parameter.
     * @since 3.4.1
     */
    ...
    /**
     * Mapping from {@code java.util.logging.Level} to
     * {@code org.snmp4j.log.LogLevel}.
     *
     * @param level
     *    The {@code Level} to mapped
     * @return
     *    the {@code LogLevel} mapped to or {@link LogLevel#NONE} if
     *    {@code null} was specified as the parameter.
     * @since 3.4.1
     */
