...
/**
 * A {@code Target} interface defines an abstract representation of a remote SNMP entity. It represents a target with an
 * Address object, as well protocol parameters such as retransmission and timeout policy.
 *
 * @author Frank Fock
 * @version 3.1.0
 */
public interface Target<A extends Address> extends Serializable, Cloneable {
    ...
    /**
     * Gets the prioritised list of transport mappings to be used for this target. The first mapping in the list that
     * matches the target address is chosen for sending new requests.
     *
     ...
     *
     * @return an {@code int} value as defined in the {@link org.snmp4j.security.SecurityModel} interface or any third
     * party subclass thereof.
     */
    int getSecurityModel();

    /**
     * Gets the security name associated with this target. The security name is used by the security model to lookup
     * further parameters like authentication and privacy protocol settings from the security model dependent internal
     * storage.
     *
     * @return an {@code OctetString} instance (never {@code null}).
     */
