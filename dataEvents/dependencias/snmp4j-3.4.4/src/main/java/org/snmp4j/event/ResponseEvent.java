...
public class ResponseEvent<A extends Address> extends EventObject {
    ...
    /**
     * Creates an <code>ResponseEvent</code> instance with an exception object indicating a message processing error.
     *
     * @param source
     *         the event source.
     * @param peerAddress
     ...
     *
     * @return a PDU instance if a response has been received. If the request timed out then <code>null</code> will be
     * returned.
     */
     ...
     *
     * @return the transport <code>Address</code> of the command responder that send this response, or <code>null</code>
