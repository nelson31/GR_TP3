...
/**
 * The <code>LogControl</code> tool can be used to control the log levels of agents implementing the SNMP4J-LOG-MIB.
 * <p>
 * Run <code>java -cp SNMP4J.jar org.snmp4j.tools.console.LogControl help</code> to get help and command usage.
 *
 * @author Frank Fock
 * @version 1.10
 * @since 1.10
...
public class LogControl {
    ...
    private <A extends Address> void setLevel(Snmp snmp, Target<A> target, PDUFactory pduFactory)
            throws IOException {
        ...
        if (logger != null) {
            ...
            ResponseEvent<A> response = snmp.set(pdu, target);
    ...
    private <A extends Address> void verifyLoggerModification(Snmp snmp, Target<A> target, PDU pdu, OID levelOID,
                                                              String logger, OID loggerIndex, String newLevel,
                                                              ResponseEvent<A> response) throws
            IOException {
        pdu.clear();
