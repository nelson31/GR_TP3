...
public class MessageDispatcherImpl implements MessageDispatcher {
    ...
    public <A extends Address> PduHandle sendPdu(TransportMapping<? super A> transport, Target<A> target, PDU pdu,
        ...
        try {
            ...
            if (transport == null) {
                throw new UnsupportedAddressClassException(
                        "Unsupported address class (transport mapping): " +
                                transportAddress.getClass().getName(), transportAddress.getClass());
            ...
            if (status == SnmpConstants.SNMP_ERROR_SUCCESS) {
                ...
                throw new MessageException("Message processing model " + mp.getID() + " returned error: " +
    ...
    public <A extends Address> int returnResponsePdu(int messageProcessingModel, int securityModel, byte[] securityName,
        ...
        try {
            ...
            TransportMapping<? super A> transport = stateReference.getTransportMapping();
            if (transport == null) {
