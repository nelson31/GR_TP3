...
/**
 * The {@code StateReference} class represents state information associated with SNMP messages. The state reference
...
public class StateReference<A extends Address> implements Serializable {
     ...
     *         Address
     * @param peerTransport
     *         the {@code TransportMapping} to be used to communicate with the peer.
     * @param secModel
     *         SecurityModel
     * @param secName
     *         a community string.
