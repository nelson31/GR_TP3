...
/**
 * The <code>TSM</code> (Transport Security Model) implements a {@link SecurityModel} which uses transport security
...
public class TSM extends SNMPv3SecurityModel {
    ...
    public int generateRequestMessage(int messageProcessingModel,
                                      ...
                                      TransportStateReference tmStateReference, SecurityStateReference securityStateReference) throws IOException {
     ...
     *
     * @return <code>true</code> if the transport domain prefix is prepended to the securityName.
     */
