...
public class TestPriv3DES
  ...
  public static void testKey()
  {
    ...
    protos.addAuthenticationProtocol(new AuthMD5());
    protos.removePrivacyProtocol(Priv3DES.ID);
    Priv3DES priv3DES = new Priv3DES();
    if (priv3DES.isSupported()) {
        protos.addPrivacyProtocol(priv3DES);
        ...
        System.out.println("WARNING: 3DES privacy key not tested because protocol is not supported by Java Runtime");
    }
  }
  ...
  public static void testEncrypt()
  {
      ...
      if (pd.isSupported()) {
          ...
          System.out.println("WARNING: 3DES privacy encryption not tested because protocol is not supported by Java Runtime");
      }
    }
  /*
